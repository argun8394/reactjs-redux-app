        ...
        <div className="navBarPadding containerDiv bg-white">
          <div className="flex items-center font-[500] justify-between">
            ...
            <div className="flex justify-center gap-3 text-[16px]">
              ...
              >
                {showFavorites ? "Tüm Ürünler" : "Beğenilenler"}
              </button>
            </div>
          </div>
          <div className="flex flex-wrap justify-center mt-6 gap-3 p-3">
            {!productSlider &&
              displayedProducts.map((item, index) => (
                <div
                  key={index}
                  className="relative w-full min-[480px]:w-[45%] min-[768px]:w-[23%] min-[1220px]:w-[24%] p-[13px] border"
                >
                  <div
                    className="absolute p-[6px] top-[20px] right-[20px] rounded-[36px] bg-[#FFFFFF]"
